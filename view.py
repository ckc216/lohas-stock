...
class AppView:
                ...
                <ul class="nav-list">
                    <li class="nav-item">
                        ...
                        <div class="dropdown-menu">
                            <a href="/?page=individual" target="_self" class="dropdown-item">Individual Analysis</a>
                            <a href="/?page=dashboard" target="_self" class="dropdown-item">Market Dashboard</a>
                        </div>
                    </li>
                    <li class="nav-item">
    ...
    def render_market_dashboard(df: pd.DataFrame):
        ...
        st.dataframe(filtered_df[display_cols], width='stretch', height=600, hide_index=True)